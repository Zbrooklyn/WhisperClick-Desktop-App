...
mod tests {
    ...
    fn torture_state_clone_copy() {
        ...
        let s2 = s;
        // The redundant clone is the assertion. This test exists to prove
        // AppState is Copy *and* still answers .clone() the same way, so
        // clippy::clone_on_copy is telling us to delete the thing under test.
