...
if (modal) await modal.screenshot({ path: OUT + '/vf-review.png' });
...
if (modal) await modal.screenshot({ path: OUT + '/vf-actions.png' });
// close menu
...
if (modal) await modal.screenshot({ path: OUT + '/vf-ask.png' });
